...
class Main {
    public static void main(String[] args) {
        ...
        s.push(10);
        System.out.println("____After Appending 10______ ");
        s.currstateStack();
        System.out.println("top element is "+s.peek());
        System.out.println("is this stack empty : "+s.isEmpty());
        s.push(20);
        System.out.println("______After Appending 20_______ ");
        s.currstateStack();
        System.out.println("top element is "+s.peek());
        System.out.println("is this stack empty : "+s.isEmpty());
        
        s.pop();
        System.out.println("_______After pop oparation________ ");
        s.currstateStack();
        System.out.println("top element is "+s.peek());
        System.out.println("is this stack empty : "+s.isEmpty());
    }
